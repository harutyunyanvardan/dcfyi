...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://dcfyi:D1DkS42Hw9PabaAnSjYiGJlvF@localhost/dcfyi_aghdev_drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://dcfyi:D1DkS42Hw9PabaAnSjYiGJlvF@localhost/dcfyi_aghdev_civicrm?new_link=true');
  }
}
...
$civicrm_root = '/srv/www/aghdev/public_html/sites/all/modules/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/srv/www/aghdev/public_html/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://aghdev.dcfyi.org/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '5kNp%%siteKey%%cTZ5vqljt:+eOucszbO>]Nu]');
}
...
if (!defined('CIVICRM_MAIL_LOG')) {
  define( 'CIVICRM_MAIL_LOG', '/srv/www/aghdev/public_html/sites/default/files/civicrm/templates_c//mail.log');
}
